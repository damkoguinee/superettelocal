...
if (isset($_SESSION['pseudo'])) {
    ...
    if ($products['statut']!="vendeur") {
        ...
        if (isset($_GET['scannerc']) or !empty($_SESSION['scannerc'])) {?>
            <div class="navsearch">                        
                <div class="search">
                    <form method="GET" action="fourcommande.php" id="suite">

                        <input id="reccode" type = "search" name = "scanneurc" placeholder="scanner un produit" onchange="document.getElementById('suite').submit()">
                    </form>
                </div>
                <a href="fourcommande.php?ventec"><input style="width: 100%;height: 30px; font-size: 20px; background-color: red;color: white; cursor: pointer;"  type="submit" value="Saisir"></a>
                <a href="fourcommande.php?newc"><input style="height: 30px; padding-left: 30px; font-size: 20px; background-color: green;color: white; cursor: pointer;"  type="submit" value="Nouvelle commande"></a>
            </div><?php
        }else{?>
            <div class="navsearch">
                <div class="search">
                    <form method="GET" action="fourcommande.php" id="suite" name="term">
                ...
                <a href="fourcommande.php?scannerc"><input style="width: 100%;height: 30px; font-size: 20px; background-color: red;color: white; cursor: pointer;"  type="submit" value="Scanner"></a>
                <a href="fourcommande.php?newc"><input style="height: 30px; padding-left: 30px; font-size: 20px; background-color: green;color: white; cursor: pointer;"  type="submit" value="Nouvelle commande"></a>
            </div><?php
        }
        if (isset($_GET['terme'])) {
            ...
            <div class="expoline"><?php
                ...
                foreach ( $products as $product ){?>
                    ...
                    <div class="boxc">
                        <nav_lateral>
                            <ul>                            
                                <li class="logo"><a href="fourcommande.php?desig=<?= $product->designation; ?>&idc=<?=$product->id;?>&pa=<?=$product->prix_achat;?>&pv=<?=$product->prix_vente;?>"><?php
                    ...
                    <div class="box">
                        ...
                        <ul style="margin-left: -35px; margin-top: 0px; margin-bottom: 20px;">                          
                            <li class="logo">
                                ...
                                <a href="fourcommande.php?desig=<?= $product->designation; ?>&idc=<?=$product->id;?>&pa=<?=$product->prix_achat;?>&pv=<?=$product->prix_vente;?>"><?php
