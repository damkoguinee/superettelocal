    ...
    if ($products['level']>=3) {
        ...
        <div class="decaissement">
            ...
            <div class="box_decaiss">
                ...
                <form method="post"  action="decpersonnel.php" target="_blank"><?php
        ...
        if (isset($_POST['montant'])){
            ...
            if ($_POST['montant']<0){?>
                ...
                if ($_POST['montant']!="") {
                    ...
                    $DB->insert('INSERT INTO decpersonnel (numdec, montant, payement, coment, client, cprelever, date_payement) VALUES(?, ?, ?, ?, ?, ?,  now())',array('retp'.$numdec, $_POST['montant'], $_POST['mode_payement'], $_POST['coment'], $_POST['client'], $_POST['compte']));

                    

                    $DB->insert('INSERT INTO banque (id_banque, montant, libelles, numero, date_versement) VALUES(?, ?, ?, ?, now())', array($_POST['compte'], -$_POST['montant'], "Retrait(".$_POST['coment'].')', 'retp'.$numdec));
                    

                    $DB->insert('INSERT INTO bulletin (nom_client, montant, libelles, numero, date_versement) VALUES(?, ?, ?, ?, now())', array($_POST['client'], -$_POST['montant'], "Retrait employer", 'retp'.$numdec));
                    ...
                    if (isset($_POST["valid"])) {
                        ...
                        header("Location: printdecpersonnel.php");
        ...
        <div class="listedec"> 
            ...
            <table class="payement" style="width: 80%;">
                ...
                <thead>
                    ...
                    <tr>
                      <th class="legende" colspan="6" height="30"><?php echo "Paiement des salariés de  " .date("Y"). "  à  ".date("H:i") ?></th>
                    </tr>
                ...
                <tbody><?php 
                    ...
                    $products = $DB->query('SELECT numdec, montant, coment, nom_client as client, DATE_FORMAT(date_payement, \'%d/%m/%Y \à %H:%i:%s\')AS DateTemps FROM decpersonnel inner join client on client=client.id WHERE YEAR(date_payement) = :annee ORDER BY(numdec)DESC', array('annee' => date('Y')));
                    ...
                    foreach ($products as $product ){
                        ...
                        <tr>
                            ...
                            <td><a href="decpersonnel.php?deleteret=<?=$product->numdec;?>"> <input style="width: 100%;height: 30px; font-size: 17px; background-color: red;color: white; cursor: pointer;"  type="submit" value="Supprimer" onclick="return alerteS();"></a></td>
