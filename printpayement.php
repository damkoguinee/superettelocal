...
<page backtop="10mm" backleft="10mm" backright="10mm" backbottom="10mm" footer="page;">
  ...
  <table style="margin:0px; font-size: 18px;color: black; background: white;" >
    ...
    <tr>
      <td><strong><?="Paiement Facture N°: " .$_SESSION['num_cmd']; ?></strong></td>
    </tr>

    <tr>
      <td><?php echo "Paiement:  " .strtolower($_SESSION['payement']); ?></td>
    </tr>

    <tr>
      <td><?php echo "Montant Payé:  " .number_format($_SESSION['montant'],2,',',' '); ?></td>
    </tr>

    <tr>
      <td><?php echo "Reste à Payer:  " .number_format($_SESSION['reste'],2,',',' '); ?></td>
    </tr>
