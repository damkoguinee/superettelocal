	...
	if (!empty($prodvalidc)) {?>
	 	...
	 	<table class="tabpanierc" style="margin-top: 30px;">
			...
			foreach($prodvalidc as $key=> $product){
				...
				<form id="modifcom" action="fourcommande.php?modifcom" method="POST">
					...
					<tbody>
						...
						<td class="supc">
							<a onclick="return alerteV();" href="fourcommande.php?delpc=<?= $product->id_produit; ?>" class="del"><img src="img/sup.jpg"></a>
						</td>
		...
		<form id="naissance" method="POST" action="fourcommande.php" style="margin-top: 0px; margin-top:10px;" >
